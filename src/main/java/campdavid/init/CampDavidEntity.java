	...
	public static class RegistrationHandler {
		...
		public static void registerEntities(final RegistryEvent.Register<EntityEntry> event) {
			final EntityEntry[] entries = {
					...
					createBuilder("basic_entity_mob").entity(BasicEntityMob.class).tracker(80, 3, true).egg(0x4286f4, 0xf44141).build()
			};
		...
		private static void addSpawns() {
			...
			copySpawns(BasicEntityMob.class, EnumCreatureType.MONSTER, EntityCreeper.class, EnumCreatureType.MONSTER);
		}
